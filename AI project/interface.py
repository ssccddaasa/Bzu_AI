...
class display():
    ...
    def __init__(self, l: list, lf, Table: list[list]):
        ...
        Exit = PhotoImage(file=path + "Sharp Button Outline Dark Mode.png")
        Button(
            master=self.window,
            image=Exit,
            borderwidth=0,
        ...
        imgNext = PhotoImage(file=path + "Next.png")
        bNext = Button(
            master=self.window,
            image=imgNext,
            borderwidth=0,
        ...
        imgPrevious = PhotoImage(file=path + "Previous.png")
        bPrevious = Button(
            master=self.window,
            image=imgPrevious,
            borderwidth=0,
...
def main(dec, flag):  # show(true) or to insert(false)
    ...
    img0 = PhotoImage(file=path + "go_from_main.png")
    img1 = PhotoImage(file=path + "backvector.png")
    imgConfirm = PhotoImage(file=path + "confirm.png")
    lconfirm = []
    if flag == 'i':
        b0 = Button(
            image=img0,
    ...
    background_img = PhotoImage(file=path + "betweenbackground.png")
    background = canvas.create_image(
        800.0, 450.0,
        image=background_img)
...
def start(dec):
    ...
    background_img = PhotoImage(file=path + "background_dark.png")
    background = canvas.create_image(
        800.0, 450.0,
        image=background_img)

    img0 = PhotoImage(file=path + "search by courses.png")
    Button(
        image=img0,
        borderwidth=0,
        highlightthickness=0,
    ...
    img2 = PhotoImage(file=path + "search by instructor’s name.png")
    Button(
        image=img2,
        borderwidth=0,
        highlightthickness=0,
    ...
    exit_img = PhotoImage(file=path + "exit_img.png")
    b2 = Button(
        image=exit_img,
        borderwidth=0,
        bg='green',
